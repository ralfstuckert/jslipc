...
public class JslipcChannelOutputStreamTest {

	@Mock
	private WritableJslipcByteChannel channelMock;
	...
	public void testJslipcChannelOutputStream() {
		new JslipcChannelOutputStream(null);
	}

	@SuppressWarnings("resource")
	@Test
	public void testWrite() throws Exception {
		JslipcChannelOutputStream os = new JslipcChannelOutputStream(channelMock);
		mockWriteByte(17);
		os.write(17);
		verifyWriteCalled();
	...
	public void testWriteMayBlock() throws Exception {
		final JslipcChannelOutputStream os = new JslipcChannelOutputStream(
				channelMock);
	...
	public void testWriteByteArrayMayBlock() throws Exception {
		final JslipcChannelOutputStream os = new JslipcChannelOutputStream(channelMock);
	...
	public void testClose() throws Exception {
		final JslipcChannelOutputStream is = new JslipcChannelOutputStream(
				channelMock);
		is.close();
